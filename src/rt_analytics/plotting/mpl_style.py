...
FLUTTER_STYLE = "qb-flutter.mplstyle"
...
def mpl_style(flutter: bool = False, dark: bool = True, minor_ticks: bool = True):
    """Some of the tick properties cannot be set using ``plt.style.use``.
    ...
    plt.style.use(
        ...
        for style in [
            COMMON_STYLE if not flutter else FLUTTER_STYLE,
            DARK_STYLE if dark else LIGHT_STYLE,
        ]
    )
